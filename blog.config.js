...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '15d5d44edc2c8061a540f7a0cc706c3f,en:15d5d44edc2c8061a540f7a0cc706c3f',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.sprunkicorruptbox.io', // 网站地址
  ...
  // 文章URL前缀
  POST_URL_PREFIX: process.env.NEXT_PUBLIC_POST_URL_PREFIX ?? 'game',
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Experience the unique charm of Sprunki Corruptbox, an innovative game merging horror, puzzles, and music. Visit sprunkicorruptbox.io now to play Sprunki Corruptbox 1, 2, and 3 versions online for free!', // 站点描述，被notion中的页面描述覆盖
